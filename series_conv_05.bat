...
call .\bin\GliomaModel.exe -GM .\_input\conv_05_8.data .\_input\vS_1d_2.data .\_output\1d_v2_conv_05_8.data
call .\bin\GliomaModel.exe -GM .\_input\conv_05_9.data .\_input\vS_1d_2.data .\_output\1d_v2_conv_05_9.data